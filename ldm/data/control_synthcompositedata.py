...
DATA_PATH_1 = "/raid/wenquanlu/RHD/RHD_published_v2/"
DATA_PATH_2 = "/raid/wenquanlu/synthesisai/"
...
class Control_composite_Hand_synth_data(Dataset):
    def __init__(self):
        self.data = []
        with open('../RHD/RHD_published_v2/rgb_caption.json', 'rt') as f1:
            for line in f1:
                item = json.loads(line)
                item['dataset'] = 'RHD'
                self.data.append(item)     
        with open('../synthesisai/rgb_caption.json', 'rt') as f2:
            for line in f2:
                item = json.loads(line)
